...
export default class ImageViewer extends React.Component<Props, State> {
  ...
  public jumpToCurrentImage() {
    // 跳到当前图的位置
    this.positionXNumber = this.width * (this.state.currentShowIndex || 0) * ((this.props.lang == "ar") ? 1 : -1);
  ...
  public handleHorizontalOuterRangeOffset = (offsetX: number = 0) => {
    ...
    const offsetXRTL = !(this.props.lang == "ar") ? offsetX : -offsetX;
  ...
  public handleResponderRelease = (vx: number = 0) => {
    const vxRTL = (this.props.lang == "ar") ? -vx : vx;
    const isLeftMove = (this.props.lang == "ar")
      ? this.positionXNumber - this.standardPositionX < -(this.props.flipThreshold || 0)
      : this.positionXNumber - this.standardPositionX > (this.props.flipThreshold || 0);
    const isRightMove = (this.props.lang == "ar")
      ? this.positionXNumber - this.standardPositionX > (this.props.flipThreshold || 0)
      : this.positionXNumber - this.standardPositionX < -(this.props.flipThreshold || 0);
  ...
  public goBack = () => {
    ...
    this.positionXNumber = !(this.props.lang == "ar")
