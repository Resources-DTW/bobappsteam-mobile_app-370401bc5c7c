...
typedef NS_ENUM(NSInteger, OPPErrorCode) {
    ...
    /// Invalid framework version. Versions of base and extension frameworks are not matching. **Deprecated**: not used anymore.
    OPPErrorCodeFrameworkVersionInvalid __deprecated_enum_msg("The attribute is no longer used.") = 5000,
